...
var encodedData = require('soop').load('Dogecore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('Dogecore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('Dogecore/lib/Address', {
